  ...
  return (
    <>
      ...
      >
        ...
        <div class="mx-8 bg-transparent">
          <div class="bg-transparent  flex justify-center font-bold">{props.hour}</div>
          <div class="bg-transparent  flex justify-center font-bold">{props.name}</div>
        </div>
      </div>
    </>
  )
